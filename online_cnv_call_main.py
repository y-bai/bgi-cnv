...
"""
    File Name: online_cnv_call_main.py
    Description:
...
from online import online_call_mp_gpu
...
def main(args):
    ...
    # online_call(in_segs_root_dir, cnv_out_root_dir, model_weight_dir, **params)
    online_call_mp_gpu(in_segs_root_dir, cnv_out_root_dir, model_weight_dir, **params)
