...
import pyhsmm.pybasicbayes
import pyhsmm
from pyhsmm.util.general import rle

class _Labels(pyhsmm.pybasicbayes.internals.labels.Labels):
    @property
    def T(self):
        return self.N
...
class Mixture(_MixturePropertiesMixin,pyhsmm.pybasicbayes.models.Mixture):
    pass

class MixtureDistribution(_MixturePropertiesMixin,pyhsmm.pybasicbayes.models.MixtureDistribution):
    pass
